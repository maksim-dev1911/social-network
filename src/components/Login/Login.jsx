...
import formStyle from '../common/FormControls/FormsControls.module.css'
...
const LoginForm = ({handleSubmit, error, captchaUrl}) => {
    return (
            <form onSubmit={handleSubmit} className={classes.sign_block}>
                <div>
                    <div>
                        <h1 className={classes.text_signIn}>Sign in</h1>
                    </div>
                    ...
                    <div>
                        <div>
                            <Field placeholder={"Login"} name="email" component={Input} validate={[required]} className={classes.input}/>
                        </div>
                        <div>
                            <Field placeholder={"Password"} type="password" name="password" component={Input} validate={[required]} className={classes.input}/>
                        </div>
                    </div>
                    <div>
                        <div className={classes.remember}>
                            <p>Remember me:</p>
                            <Field className={classes.checkbox} name="rememberMe" component={Input} type="checkbox"/>
                        </div>
                        {captchaUrl && <img src={captchaUrl} />}
                        {captchaUrl && <Field className={classes.symbol_captcha} placeholder='Symbols from image' name='captcha' validate={[required]} component='input'/>}
                        <div>
                            <button className={classes.button_start}>Get Started</button>
                        </div>
        ...
        <main className={classes.content}>
            <div className={classes.background_img}>
                <div className={classes.in_container}>
                    <img className={classes.banner_in}
                ...
                <div className={classes.container_text}>
                    <h1 className={classes.text_banner}>
                        Make your life more interesting with Social Network
                    </h1>
                    <div >
